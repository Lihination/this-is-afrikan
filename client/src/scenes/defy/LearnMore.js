        ...
        return ( 
            <Fragment>
                ...
                this.state.popup ? <LearnPopUp closePopup={this.openPopup}>
                                    <FunFacts closePopup={this.openPopup} change={this.props.change} />
                                </LearnPopUp>: null
            }
                <div className="learn-more">
                    ...
                    <div className="wrapper">
                        ...
                        <div className="inner">
                            ...
                            <p>
                            Amusingly, this very real but now defunct writing system was <i><b>the basis for the fictional written language of Wakanda</b></i> in the movie Black Panther. <a onClick={()=>{this.openPopup()}}><b>(See other fun facts)</b></a>
                            </p>
