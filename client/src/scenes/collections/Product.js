    ...
    render() {
        ...
        return (
            <div className="product">
                ...
                <Link className="product-img" to={{ pathname: "product", search: '?id='+this.props.product.id+ '&collection='+ this.props.collection, state: { id: this.props.product.id, collection: this.props.collection } }}>
                ...
                <Link className="button" to={{ pathname: "product", search: '?id='+this.props.product.id+ '&collection='+ this.props.collection, state: { id: this.props.product.id, collection: this.props.collection } }}
                    ...
                    ><SeeMoreIcon/></Link>
                {/* <h4>{this.props.product.title==="Laughing Leopard"? "Defy Leopard": this.props.product.title==="Hidden Crocodile"? "Defy Crocodile":
                     this.props.product.title==="Coiled Python"? "Defy Python": this.props.product.title }</h4> */}
